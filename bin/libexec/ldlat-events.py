...
def print_ld_trace(raw_buf, sample, param_dict):
#	data = struct.unpack_from("<IQ", raw_buf)
#	flags = data[0]
#	payload = data[1]
#	exact_ip = flags & 1
        ...
        print( "%lx %08lx %d %u.%09u \n" %  (ip, addr, cpu, ts / 1000000000, ts %1000000000, ), end='')
...
#        addr = sample["addr"]
#        print (addr)
#        if "mem-loads" in name:
        print_ld_trace(raw_buf, sample, param_dict)
        #print ("Printing Call graph")
        #print (callGraph)
        #print ("Name of function")
#        line       = param_dict["get_line"]
#        print (name)
