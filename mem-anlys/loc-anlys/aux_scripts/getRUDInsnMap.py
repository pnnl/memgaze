        ...
        for fileLine in f:
            ...
            if data[0] == '--insn':
                ...
                if (appName == 'mini-v3'): 
                  ...
                  varVersion = 'm-v3: '
                if (appName == 'alpaca'): 
                  logFile = '/home/suri836/Projects/run_memgaze/alpaca.cpp-81bd894/mg-alpaca-noinline/chat-sel-memgaze.binanlys'
                  objFile = '/home/suri836/Projects/run_memgaze/alpaca.cpp-81bd894/mg-alpaca-noinline/obj_chat'
                  objFile_C = ''
                  varVersion = 'al: '
                if (appName == 'xsbench'): 
                ...
                if (appName == 'xsbench-read'): 
                  logFile = '/home/suri836/Projects/run_memgaze/XSBench/XSBench/openmp-noflto/memgaze-xs-read-large/XSBench-memgaze.binanlys'
                  objFile = '/home/suri836/Projects/run_memgaze/XSBench/XSBench/openmp-noflto/memgaze-xs-read-large/obj_XSBench'
                  objFile_C = ''
                  varVersion = 'xs: '
                if (appName == 'xsbench-read-irr'): 
                  logFile = '/home/suri836/Projects/run_memgaze/XSBench/XSBench/openmp-noflto/memgaze-xs-read-irregular/XSBench-memgaze.binanlys'
                  objFile = '/home/suri836/Projects/run_memgaze/XSBench/XSBench/openmp-noflto/memgaze-xs-read-irregular/obj_XSBench'
                  objFile_C = ''
                  varVersion = 'xs: '
                ...
                if (appName == 'xsbench-sel'): 
                  ...
                  varVersion = 'xs: '
                if (appName == 'gemm'): 
                  logFile = '/home/suri836/Projects/run_memgaze/mat_mult_reorder_tile/gemm-memgaze.binanlys'
                  objFile = '/home/suri836/Projects/run_memgaze/mat_mult_reorder_tile/obj_gemm'
                  objFile_C = ''
                  varVersion = 'mm: '
