...
#         print line
   ...
   for line in lines:
      if "</MetricTable>" in line:
         ...
         #9 im|L1 (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"im|L1 (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"0\" show-percent=\"0\">\n")
         f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['LOADS:Mean(I)'],MetricDict['L1_hit_surv(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["im-L1(I)"]=str(index)      
         #9 im|L1 (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"im|L1 (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"0\">\n")
         ...
         #9 im|L2 (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"im|L2 (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"0\" show-percent=\"0\">\n")
         f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['LOADS:Mean(I)'],MetricDict['L2_hit_surv(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["im-L2(I)"]=str(index)      
         #9 im|L2 (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"im|L2 (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"0\">\n")
         ...
         #9 im|L3 (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"im|L3 (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"0\" show-percent=\"0\">\n")
         f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['LOADS:Mean(I)'],MetricDict['L3_hit_surv(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["im-L3(I)"]=str(index)      
         #9 im|L3 (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"im|L3 (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"0\">\n")
         ...
         #9 ~pf im|L3 (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"~pf im|L3 (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"0\" show-percent=\"0\">\n")
         #f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['LOADS:Mean(I)'],MetricDict['L3_hit_npf_surv(I)']))
         f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['LOADS:Mean(I)'],MetricDict['Mem_div_npf(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["im-L3_npf(I)"]=str(index)      
         #9 ~pf im|L3 (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"~pf im|L3 (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"0\">\n")
         #f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['LOADS:Mean(E)'],MetricDict['L3_hit_npf_surv(E)']))
         f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['LOADS:Mean(E)'],MetricDict['Mem_div_npf(E)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         ...
         #10 ~pf fp (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"~pf fp (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"1\" show-percent=\"0\">\n")
         f2.write("        <MetricFormula t=\"finalize\" frm=\"(${}*{})/${} \"/>\n".format(MetricDict['LOADS:Mean(I)'],str(word),MetricDict['im-L3_npf(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["fp-L3_npf(I)"]=str(index)      
         #10 ~pf fp (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"~pf fp (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"0\">\n")
         ...
         #10 ~pf fp% (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"~pf fp% (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"1\" show-percent=\"1\">\n")
         f2.write("        <MetricFormula t=\"finalize\" frm=\"(${}/${})*100 \"/>\n".format(MetricDict['fp-L3_npf(I)'],MetricDict['fp-L3(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["fp-L3_percent(I)"]=str(index)      
         #10 ~pf fp% (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"~pf fp% (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"1\">\n")
         ...
         #11 ~pf rate (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"~pf rate (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"1\" show-percent=\"0\">\n")
         f2.write("        <MetricFormula t=\"finalize\" frm=\"${}/${} \"/>\n".format(MetricDict['fp-L3_npf(I)'],MetricDict['LOADS:Mean(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["fp-L3_npf_rate(I)"]=str(index)      
         #11 ~pf rate (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"~pf rate (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"0\">\n")
         ...
         #12 ~pf rate% (I)
         f2.write("    <Metric i=\""+str(index)+"\" n=\"~pf rate% (I)\" v=\"derived-incr\" t=\"inclusive\" partner=\""+str(index+1)+"\" show=\"1\" show-percent=\"1\">\n")
         f2.write("        <MetricFormula t=\"finalize\" frm=\"(${}/${})*100 \"/>\n".format(MetricDict['fp-L3_npf_rate(I)'],MetricDict['fp-L3_rate(I)']))
         f2.write("        <Info><NV n=\"units\" v=\"events\"/></Info>\n")
         f2.write("    </Metric>\n")
         MetricDict["fp-npf_rate(I)"]=str(index)      
         #12 ~pf rate% (E)
         f2.write("    <Metric i=\""+str(index+1)+"\" n=\"~pf rate% (E)\" v=\"derived-incr\" t=\"exclusive\" partner=\""+str(index)+"\" show=\"0\" show-percent=\"1\">\n")
