...
#   /home/kili337/Projects/IPPD/gitlab/palm-memory/install/bin/miami  --bin_path ${bin}  --load_class 1 --inst_loads=1 --inst_stores=1 --inst_strided=1 --inst_indirect=1 --inst_frame=0  &> ${bin}.log
   /home/kili337/Projects/IPPD/gitlab/palm-memory/install/bin/miami  -m ~/x86_SandyBridge_EP.mdf   --bin_path ${bin}  --load_class 1 --inst_loads=1 --inst_stores=0 --inst_strided=1 --inst_indirect=1 --inst_frame=0 --lcFile=${bin}.lc  &> ${bin}.log
   #mv ${bin}_PTW ${bin}.out
#done
