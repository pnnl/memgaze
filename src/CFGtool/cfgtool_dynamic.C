 ...
 */
/* 
 * File: cfgtool_dynamic.C
 * Author: Gabriel Marin, mgabi99@gmail.com
 *
 * Implements the control management logic for a CFG profiler PIN tool.
 * This tool uses a purely dynamic approach to incrementally discover the 
 * CFGs of executed routines during execution.
 */
...
{
    cerr <<
        "This tool dynamically discovers CFGs of applications.\n"
        "\n";
