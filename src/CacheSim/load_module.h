 ...
 *
 * Data bookkeeping at the load module level for a cache simulation tool.
 */

#ifndef MIAMI_CACHETOOL_LOAD_MODULE_H
#define MIAMI_CACHETOOL_LOAD_MODULE_H
...
public:
   ...
   // The next two methods use and modify shared data. 
