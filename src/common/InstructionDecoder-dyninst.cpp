...
struct instruction_data {
    ...
    Dyninst::ParseAPI::Function * parse_func;
    Dyninst::ParseAPI::Block * parse_blk;
    std::vector<Dyninst::Assignment::Ptr> assignments;
    Dyninst::InstructionAPI::Instruction::Ptr dyn_insn;
...
//void dynXlate_dumpInsn(Dyninst::Address pc, Dyninst::InstructionAPI::Instruction::Ptr insn, std::vector<Dyninst::Assignment::Ptr> & assignments)
void dynXlate_dumpInsn(instruction_data& insn_data)
{
  using std::cerr;
